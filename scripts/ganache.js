...
server.listen(8546, function(err, blockchain) {
    ...
    let keyVars = "DEVELOPMENT_WEB3_PROVIDER_URL_TO_BE_FORKED=\"" + process.env.DEVELOPMENT_WEB3_PROVIDER_URL_TO_BE_FORKED + "\"\n";
    keyVars += "DEVELOPMENT_ADDRESS=\"" + Object.keys(blockchain['unlocked_accounts'])[0] + "\"\n";
